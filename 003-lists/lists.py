bikes = ['Pulsar NS 200', 'Honda CBR 600', 'Yamaha R15', 'Honda Shine', 'Yamaha FZ',
         'Duke 250', 'Hayabusa 1000', 'Ducati 1000', 'Harley Davidson', 'Royal Enfield']
...
# Reversing a list and storing in a new list
print("\Reversing a list and storing in a new list")
bikes_reversed = reversed(bikes)
print('bikes_reversed:', bikes_reversed)

# Reverse a list in place
print("\nReverse a list permanently, no sorting")
bikes.reverse()

# Sorting a list and storing in a new list
print("\nSorting a list and storing in a new list")
